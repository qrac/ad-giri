...
ツールバーのアイコンを押すと、クリックしたタブのサイトをホワイトリストへ追加してブロックを解除し、灰色のアイコンへ切り替えます。もう一度押すとホワイトリストから削除してブロックを再開します。権限を最小化するため、クリック前に他タブのアイコン状態を常時同期することはしません。
...
| `activeTab` | ユーザーがaction iconをクリックしたタブで、サイト単位の切り替えに必要なhostnameを一時的に確認し、アイコン状態を更新するため |
